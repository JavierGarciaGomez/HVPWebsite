...
define('SUB_HEADING_TEXT_1', 'A cada visitante de nuestro catalogo le es asignado una \'cesta de visitante\'. Esto permite al invitado guardar sus productos en una cesta temporal. Una vez que el visitante abandona el catalogo, tambi&eacute;n desaparece el contenido de su cesta.');
...
define('SUB_HEADING_TEXT_3', 'Si un asociado a&ntilde;ade un articulo a su \'cesta de visitante\' y despu&eacute;s decide entrar a su cuenta para usar su \'cesta de asociado\', el contenido de la \'cesta de visitante\' ser&aacute; a&ntilde;adido a la \'cesta de asociado\' autom&aacute;ticamente.');
