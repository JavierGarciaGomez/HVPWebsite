...
define('NAVBAR_TITLE_3', 'Pedido N&uacute;m. %s');

define('HEADING_TITLE', 'Datos del pedido');

define('HEADING_ORDER_NUMBER', 'Pedido N&uacute;m. %s');
...
define('HEADING_SHIPPING_METHOD', 'Gastos de envi&oacute;');
...
define('HEADING_DOWNLOAD', 'Descarga tus productos aqu&iacute;');
?>
