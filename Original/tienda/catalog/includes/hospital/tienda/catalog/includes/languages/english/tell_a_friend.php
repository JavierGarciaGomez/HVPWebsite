...
define('ERROR_TO_NAME', 'El email de su amigo/a no puede estar vacío.');
define('ERROR_TO_ADDRESS', 'El email de su amigo/a debe ser valido.');
define('ERROR_FROM_NAME', 'Su nombre no puede estar vacío.');
define('ERROR_FROM_ADDRESS', 'Su email debe de ser valido.');
define('ERROR_ACTION_RECORDER', 'Un email ya ha sido enviado. Por favor, inténtelo de nuevo en %s minutos.');
?>
