...
define('ENTRY_EMAIL_ADDRESS_ERROR', 'Su email debe contener un mínimo de ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' caracteres.');
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', 'Su email no parece valido - por favor haga las correcciones necesarias.');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Su email ya figura entre nuestros clientes - por favor inicie sesión con su email o cree una cuenta con un email diferente.');
define('ENTRY_EMAIL_ADDRESS_TEXT', '*');
define('ENTRY_STREET_ADDRESS', 'Direcci&oacute;n:');
define('ENTRY_STREET_ADDRESS_ERROR', 'Su dirección debe tener un mínimo de ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' caracteres.');
...
define('ENTRY_CITY_ERROR', 'Su población debe tener un mínimo de ' . ENTRY_CITY_MIN_LENGTH . ' caracteres.');
define('ENTRY_CITY_TEXT', '*');
define('ENTRY_STATE', 'Provincia:');
define('ENTRY_STATE_ERROR', 'Su provincia debe tener un mínimo de ' . ENTRY_STATE_MIN_LENGTH . ' caracteres.');
...
define('ENTRY_TELEPHONE_NUMBER_ERROR', 'Su numero de teléfono debe contener un mínimo de ' . ENTRY_TELEPHONE_MIN_LENGTH . ' caracteres.');
...
define('ENTRY_PASSWORD_ERROR', 'Su contraseña debe tener un mínimo de ' . ENTRY_PASSWORD_MIN_LENGTH . ' caracteres.');
...
define('ENTRY_PASSWORD_CURRENT_ERROR', 'Su contraseña debe tener un minimo de ' . ENTRY_PASSWORD_MIN_LENGTH . ' caracteres.');
define('ENTRY_PASSWORD_NEW', 'Nueva contrase&ntilde;a:');
define('ENTRY_PASSWORD_NEW_TEXT', '*');
define('ENTRY_PASSWORD_NEW_ERROR', 'Su nueva contraseña debe tener un minimo de ' . ENTRY_PASSWORD_MIN_LENGTH . ' caracteres.');
define('ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING', 'La confirmación de contraseña debe coincidir con su nueva contraseña.');
...
define('ERROR_TEP_MAIL', '<font face="Verdana, Arial" size="2" color="#ff0000"><b><small>TEP ERROR:</small> No he podido enviar el email con el servidor SMTP especificado. Configure su servidor SMTP en la sección adecuada del fichero php.ini.</b></font>');
...
define('TEXT_CCVAL_ERROR_UNKNOWN_CARD', 'Los primeros cuatro dígitos de su tarjeta son: %s. Si este numero es correcto, no aceptamos este tipo de tarjetas. Si es incorrecto, intentelo de nuevo.');
