...
define('TEXT_DELETE_PRODUCT_INTRO', 'Esta seguro de que desea suprimir permanentemente este producto?');
...
define('TEXT_PRODUCTS_MAIN_IMAGE', 'Principal');
define('TEXT_PRODUCTS_LARGE_IMAGE', 'Grandes imagenes');
define('TEXT_PRODUCTS_LARGE_IMAGE_HTML_CONTENT', 'Contenido HTML (para las ventanas emergentes)');
define('TEXT_PRODUCTS_ADD_LARGE_IMAGE', 'Añadir imagen grande');
define('TEXT_PRODUCTS_LARGE_IMAGE_DELETE_TITLE', 'Eliminar imagen grande del producto?');
define('TEXT_PRODUCTS_LARGE_IMAGE_CONFIRM_DELETE', 'Por favor confirmar la eliminacion de la imagen del producto.');
...
define('ERROR_CANNOT_MOVE_CATEGORY_TO_PARENT', 'Error: La categoria no se puede mover dentro de una subcategoria.');
?>
