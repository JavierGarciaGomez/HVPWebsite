...
define('TEXT_SELECTED_PAYMENT_DESTINATION', 'Esta es la direcci&oacute;n de facturaci&oacute;n seleccionada, donde se enviara la factura.');
...
define('TEXT_CREATE_NEW_PAYMENT_ADDRESS', 'Use el siguiente formulario para crear una nueva direcci&oacute;n en su libreta y usarla como direcci&oacute;n de facturaci&oacute;n en este pedido.');
